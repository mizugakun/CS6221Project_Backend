...
CREATE TABLE StorageDetail (
     ...
     KEY idx_FK_UserId (UserId),
     KEY idx_FK_ItemId (ItemId),
     CONSTRAINT FK_Storage_User FOREIGN KEY (UserId) REFERENCES User (UserId) ON DELETE CASCADE ON UPDATE CASCADE,
     CONSTRAINT FK_Storage_Item FOREIGN KEY (ItemId) REFERENCES Item (ItemId) ON DELETE CASCADE ON UPDATE CASCADE
)ENGINE=InnoDB DEFAULT CHARSET=UTF8MB4;
